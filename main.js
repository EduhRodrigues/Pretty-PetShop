...
document
  .getElementById('custom01ColorPalette')
  .addEventListener('click', addDarkShineSkyThemeFunction)
function addDarkShineSkyThemeFunction() {
  ...
  document.getElementById('iframeProducts').src =
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vQoHx1_iniuYaD89UITs6JglwISLg8OxpZoEYYDDVBMxYITsCMOsEyJ5ALC-9l6BO2z1uLnMa227a-R/pubhtml?gid=1476416633&amp;single=true&amp;widget=true&amp;headers=false'
  ...
  document.querySelector('.cardBlackProducts').style.border =
    '3px solid #00d9ff'
  document.querySelector('.cardBlackProducts').style.boxShadow =
    '0px 0px 3rem #00d9ff'
  ...
  document.querySelector('.cardBlack2 .freeDeliverySpan').style.color =
    '#00d9ff'
  document.querySelector('.cardBlack2 .discountCouponSpan').style.color =
    '#00d9ff'
  ...
  document.querySelector('.cardBlack3 .emergencyCareSpan').style.color =
    '#00d9ff'
  ...
  document.querySelector('.cardBlack4 .antiParasiticSpan').style.color =
    '#00d9ff'
  ...
  document.querySelector('.cardBlack6 .socializationSpan').style.color =
    '#00d9ff'
  ...
  document.querySelector('section .button').style.boxShadow =
    '0px 0px 2rem #00d9ff'
  ...
  document.querySelector('#contact .button').style.boxShadow =
    '0px 0px 2rem #00d9ff'
...
document
  .getElementById('custom02ColorPalette')
  .addEventListener('click', addAmazonBreatheThemeFunction)
function addAmazonBreatheThemeFunction() {
  ...
  document.getElementById('iframeProducts').src =
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vSQTZpnLzMpDCScHrUr31gtuKTYW2AtouDVTFD0zFcf5fMLjSyT0OcZ-9fyEOf-ZQk8qb5Sr9rTfpT6/pubhtml?gid=1476416633&amp;single=true&amp;widget=true&amp;headers=false'
...
document
  .getElementById('custom04ColorPalette')
  .addEventListener('click', addHelloPinkLolThemeFunction)
function addHelloPinkLolThemeFunction() {
  ...
  document.getElementById('iframeProducts').src =
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vQsllf3ENP9LLheTKrt1LuK3JVHdSadVOcgp1XAWszsh2V7BhYPfo0jiao06LgVCb-6GwLaf8zKSeuM/pubhtml?gid=1476416633&amp;single=true&amp;widget=true&amp;headers=false'
...
document
  .getElementById('defaultColorPalette')
  .addEventListener('click', addBlueAliveDayThemeFunction)
...
function addBlueAliveDayThemeFunction() {
  ...
  document.getElementById('iframeProducts').src =
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vQvade7ScN6Zq_7y_NkC0NAD6sE6FG3oWDGKAiAdTNNR2tzoOmEwjZ3kN8UM8C5xB4E6_As4y-wy1lU/pubhtml?gid=1476416633&amp;single=true&amp;widget=true&amp;headers=false'
